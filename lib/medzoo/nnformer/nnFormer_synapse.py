...
from lib.medzoo.nnformer_utilities.nd_softmax import softmax_helper
from torch import nn
import torch
import torch.nn.functional as nnf
import numpy as np
# from lib.medzoo.nnformer.initialization import InitWeights_He
# from lib.medzoo.nnformer.neural_network import SegmentationNetwork
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        # print('self.input_resolution is ', self.input_resolution)
...
class nnFormer(BaseModel):
    ...
    def __init__(self, crop_size=[64,128,128],
        ...
        self.spatial_trans = SpatialTransformer(crop_size)
